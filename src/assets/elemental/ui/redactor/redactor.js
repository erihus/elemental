		...
		upload: function()
		{
			return {
				...
				sendData: function(formData, e)
				{
					...
					//modification - e.hussmann -- used to work with Laravel 5 CSRF protection
					for(var header in this.opts.uploadHeaders) { 
						xhr.setRequestHeader(header, this.opts.uploadHeaders[header])
					}
