...
class ElementSeedGenerator {
    ...
    {   
        ...
        $filename = studly_case($nickname).'ElementSeeder';
    ...
    {
        return $this->files->get($this->getStubPath().'/element.stub');
    }
